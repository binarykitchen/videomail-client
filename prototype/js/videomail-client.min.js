 ...
 */
t.exports=function(e){var t,n=String.prototype.split,r=/()??/.exec("")[1]===e;return t=function(t,i,o){if("[object RegExp]"!==Object.prototype.toString.call(i))return n.call(t,i,o);var a,u,s,l,c=[],f=(i.ignoreCase?"i":"")+(i.multiline?"m":"")+(i.extended?"x":"")+(i.sticky?"y":""),d=0;i=new RegExp(i.source,f+"g");for(t+="",r||(a=new RegExp("^"+i.source+"$(?!\\s)",f)),o=o===e?-1>>>0:o>>>0;(u=i.exec(t))&&!((s=u.index+u[0].length)>d&&(c.push(t.slice(d,u.index)),!r&&u.length>1&&u[0].replace(a,(function(){for(var t=1;t<arguments.length-2;t++)arguments[t]===e&&(u[t]=e)})),u.length>1&&u.index<t.length&&Array.prototype.push.apply(c,u.slice(1)),l=u[0].length,d=s,c.length>=o));)i.lastIndex===u.index&&i.lastIndex++;return d===t.length?!l&&i.test("")||c.push(""):c.push(t.slice(d)),c.length>o?c.slice(0,o):c},t}()},{}],11:[function(e,t,n){(function(t){(function(){
/*!
 ...
 */
!function(e,r){"object"==typeof n&&void 0!==t?t.exports=r():e.requestFrame=r()}(this,(function(){"use strict";return function(e){var t,n,r,i=["moz","webkit"],o="AnimationFrame",a="Request"+o,u=window.mozRequestAnimationFrame,s=window.mozCancelAnimationFrame,l=u&&!s,c=0;
/**
