 ...
 */
t.exports=function(e){var t,n=String.prototype.split,r=/()??/.exec("")[1]===e;return t=function(t,i,o){if("[object RegExp]"!==Object.prototype.toString.call(i))return n.call(t,i,o);var a,s,u,c,l=[],f=(i.ignoreCase?"i":"")+(i.multiline?"m":"")+(i.extended?"x":"")+(i.sticky?"y":""),d=0;i=new RegExp(i.source,f+"g");for(t+="",r||(a=new RegExp("^"+i.source+"$(?!\\s)",f)),o=o===e?-1>>>0:o>>>0;(s=i.exec(t))&&!((u=s.index+s[0].length)>d&&(l.push(t.slice(d,s.index)),!r&&s.length>1&&s[0].replace(a,(function(){for(var t=1;t<arguments.length-2;t++)arguments[t]===e&&(s[t]=e)})),s.length>1&&s.index<t.length&&Array.prototype.push.apply(l,s.slice(1)),c=s[0].length,d=u,l.length>=o));)i.lastIndex===s.index&&i.lastIndex++;return d===t.length?!c&&i.test("")||l.push(""):l.push(t.slice(d)),l.length>o?l.slice(0,o):l},t}()},{}],16:[function(e,t,n){(function(t){(function(){
/*!
 ...
 */
!function(e,r){"object"==typeof n&&void 0!==t?t.exports=r():e.requestFrame=r()}(this,(function(){"use strict";return function(e){var t,n,r,i=["moz","webkit"],o="AnimationFrame",a="Request"+o,s=window.mozRequestAnimationFrame,u=window.mozCancelAnimationFrame,c=s&&!u,l=0;
/**
