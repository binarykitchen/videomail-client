...
| src/js/wrappers/visuals/recorder.js | 591 | in https://github.com/binarykitchen/videomail-client/issues/142
| src/js/wrappers/visuals/recorder.js | 628 | retry with navigator.getUserMedia_() maybe?
| src/js/wrappers/visuals/recorder.js | 768 | commented out because for some reasons server does
| src/js/wrappers/visuals/recorder.js | 773 | consider removing this later or have it for debug=1 only?
