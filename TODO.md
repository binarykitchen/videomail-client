...
| src/js/wrappers/visuals/recorder.js | 632 | retry with navigator.getUserMedia_() maybe?
| src/js/wrappers/visuals/recorder.js | 779 | commented out because for some reasons server does
| src/js/wrappers/visuals/recorder.js | 784 | consider removing this later or have it for debug=1 only?
