...
| src/js/wrappers/visuals/recorder.js | 567 | in https://github.com/binarykitchen/videomail-client/issues/142
| src/js/wrappers/visuals/recorder.js | 604 | retry with navigator.getUserMedia_() maybe?
| src/js/wrappers/visuals/recorder.js | 744 | commented out because for some reasons server does not accept such a long
| src/js/wrappers/visuals/recorder.js | 749 | consider removing this later or have it for debug=1 only?
