...
| src/js/wrappers/container.js | 326 | figure out how to fire dom's onload event again
| src/js/wrappers/container.js | 327 | or how to run all the scripts over again
