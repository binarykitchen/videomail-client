    ...
    function createError(errorParams) {
        ...
        switch(errName){
            ...
            case error_VideomailError.OVERCONSTRAINED:
                ...
                explanation = err && "constraint" in err ? "width" === err.constraint ? "Your webcam does not meet the width requirement." : `Unmet constraint: ${err.constraint}` : null == err ? void 0 : err.message;
                break;
