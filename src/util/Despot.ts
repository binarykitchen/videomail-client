...
class Despot {
  ...
  public emit<E extends keyof VideomailEvents>(
    eventName: E,
  ...
  public getListeners<E extends keyof VideomailEvents>(eventName: E) {
    return Despot.EMITTER.events[eventName];
  }

  public removeListener(eventName: keyof VideomailEvents) {
